...
public class LeftBar {
    private JFrame fr;
    private JPanel blank, dash, forBtn, profile, mainSpace, nameSpace, idSpace, detialsSpace, roleSpace, pics, queueBtn, assignBtn, scorebBtn, bbtn, mainPage;
    private JButton queue ,assign, scoreb;
    private JLabel id,  name, role;
    
    public LeftBar() throws IOException{
        fr = new JFrame();
        ...
        fr.add(mainSpace, BorderLayout.CENTER);
