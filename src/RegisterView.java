 ...
 * @author sudthirak
 */
public class RegisterView implements ActionListener, SqlInterface{
    private JFrame fr;
    ...
    public void connect(){
        ...
        try(Connection connect = DriverManager.getConnection("jdbc:mysql://localhost:3306/user_login_register","root","pass1234");
